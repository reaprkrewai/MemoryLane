...
- [x] **SEC-01**: User can set a PIN or password to lock the app (delivered in Phase 5, evidenced by 05-COMPLETION-SUMMARY.md)
- [x] **SEC-02**: Locked app requires PIN/password entry before content is visible (delivered in Phase 5, evidenced by 05-COMPLETION-SUMMARY.md)
- [x] **SEC-03**: App auto-locks after a configurable idle period (delivered in Phase 5, evidenced by 05-COMPLETION-SUMMARY.md)

### Media

- [x] **MEDIA-01**: User can attach one or more photos to an entry by selecting files from disk (delivered in Phase 5, evidenced by 05-COMPLETION-SUMMARY.md)
- [x] **MEDIA-02**: Photos are stored in the app data directory (not embedded in Markdown content) (delivered in Phase 5, evidenced by 05-COMPLETION-SUMMARY.md)
- [x] **MEDIA-03**: Attached photos are displayed within the entry view (delivered in Phase 5, evidenced by 05-COMPLETION-SUMMARY.md)
- [x] **MEDIA-04**: User can remove an attached photo from an entry (delivered in Phase 5, evidenced by 05-COMPLETION-SUMMARY.md)

### Settings & Export

- [x] **SETT-01**: User can toggle between light mode and dark mode
- [x] **SETT-02**: User can select a font size (small / medium / large)
- [x] **SETT-03**: User can export all journal data to a JSON file (delivered in Phase 5, evidenced by 05-COMPLETION-SUMMARY.md)
